#!/usr/bin/env bash
#Petit script pour descendre sur runpode le modèle ornith1.5-35b-q4 depuis huggingface_hub
#zf260609.1609, zf260830.1103
...
huggingface-cli download ornith-ai/Ornith-1.5-35B-A3B-GGUF Ornith-1.5-35B-Q4_K_M.gguf --local-dir /workspace/models
