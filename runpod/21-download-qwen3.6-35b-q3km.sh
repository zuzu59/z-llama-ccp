#!/usr/bin/env bash
#Petit script pour descendre sur runpode le modèle qwen 3.6:35b depuis huggingface_hub
#zf260609.1609, zf260816.1910
...
huggingface-cli download unsloth/Qwen3.6-35B-A3B-GGUF Qwen3.6-35B-A3B-UD-Q3_K_M.gguf --local-dir /workspace/models
...
huggingface-cli download unsloth/Qwen3.6-35B-A3B-GGUF  mmproj-F16.gguf --local-dir /workspace/models
