#!/usr/bin/env bash
#Petit script pour démarrer le serveur llama.ccp avec le tout dernier ornith1.0:35b-q6k avec vision
#zf260608.1407, zf260807.1449
...
./build/bin/llama-server \
  -m /workspace/models/deepreinforce-ai_Ornith-1.0-35B-Q6_K.gguf \
