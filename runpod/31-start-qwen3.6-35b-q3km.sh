#!/usr/bin/env bash
#Petit script pour démarrer le serveur llama.ccp avec le tout dernier qwen 3.6:35b avec vision
#zf260608.1407, zf260816.1908
...
./build/bin/llama-server \
  -m /workspace/models/Qwen3.6-35B-A3B-UD-Q3_K_M.gguf \
